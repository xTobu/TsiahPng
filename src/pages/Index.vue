                ...
                <div class="content" v-if="!state.random">
                    <ul>
                        ...
                        <li>
                            <div class="txt">
                                <p>
                                    <span>Do you ever fall into a lunch rut? Every week when planning my grocery list, I always
                                        pause when it comes to making a plan for the week's lunches. Turkey wraps again?
                                        It can be hard to find tasty and easy-to-prepare options that are also healthy.</span>
                                </p>
                            </div>
